...
from ..lm_styles import LMStyle
from ..benchmarks.code_generation import CodeGenerationProblem
...
with open(os.path.join(_prompts_dir, "few_shot_examples", "generation", "func.json")) as f:
    func = json.load(f)

with open(os.path.join(_prompts_dir, "few_shot_examples", "generation", "stdin.json")) as f:
    stdin = json.load(f)
